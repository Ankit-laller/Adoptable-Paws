...
import '../../../Utils/widgets/photo_viewer.dart';
import 'adoption_pop_up.dart';
import 'component/detail_page_container.dart';

class DetailsPage extends StatelessWidget {
  DetailsPage(
      {super.key, required this.petData, });
  final ProductModel petData;
                              ...
                              child: Row(
                                ...
                                children: [
                                   DetailPageContainer(
                                    ...
                                    image:  Image(
                                      image: NetworkImage('${petData.images?[0]}'),
                                    ),
                                    text1: "4",
                                    text2: "Age",
                                  ),
